...
class RandomNumberGeneratorInitialization
{
public:
RandomNumberGeneratorInitialization() {	InitRandom(); }
};
//RandomNumberGeneratorInitialization RNDInitInstance;	// calls constructor
